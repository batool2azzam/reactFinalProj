  ...
  return (
    <div className="leftbar" style={{ backgroundColor: Theme.main, color: Theme.secendary }} >
      <div className="logo-left" >
        {selectedTheme === "dark" ? (<img src={Logo} alt='' />):(<img src={Logo2} alt='' />)}
